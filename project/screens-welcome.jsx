/* global React, I, MODULES, ROLES, CONVOS, Shell */
...
const WelcomeScreen = ({ theme = 'light', roleId = 'rd' }) => {
      ...
      <div className="a-welcome">
        <div className="a-welcome__hd">
          ...
          <div className="row" style={{marginLeft: 'auto', gap: 12}}>
            ...
            <div className="row" style={{gap: 10}}>
              <div className="a-avatar mono" style={{width: 26, height: 26, fontSize: 10}}>{r.initials}</div>
              <div className="col" style={{lineHeight: 1.2}}>
                <div style={{fontSize: 12.5}}>{r.name}</div>
                <div className="mono" style={{fontSize: 10, color: 'var(--fg-3)'}}>{r.role}</div>
              </div>
            </div>
            <button className="a-btn ghost icon"
              onClick={nav ? () => nav.navigate('/login') : undefined}>{I.signout}</button>
          </div>
        </div>
        ...
        <div className="a-welcome__body">
          <div className="a-welcome__greet">
            ...
            <p>
              Pick a workspace to continue, or jump back into a recent thread.
            </p>
          </div>
          ...
          <div className="a-welcome__grid">
            {visible.map(m => {
              ...
              return (
                <div key={m.id} className="a-mcard"
...
Object.assign(window, { WelcomeScreen, MODULE_META });
